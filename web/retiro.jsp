<%-- 
    Document   : retiro
    Created on : 04/03/2020, 07:00:24 PM
    Author     : Alejandro-PC
--%>
                ...
                <tbody>   
                    ...
                    <tr>
                        <td   >
                            ...
                            <button data-toggle="modal" data-target="#exampleModalCenter" name="numAccount" class="btn btn-dark"  onclick="mod('<%=de.getNumero()%>')" >
                                <%=de.getNumero()%> 
                            </button>
                ...
                <div  class="modal-dialog modal-dialog-centered" role="document">
                    <div action="" class="modal-content">
                        <div class="modal-header">
                            <h3>Detalle de Retiro</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>

                        <form action="retiroSaldo"  method="post">
                            <div class="modal-body">

                                <div class="form-group">
                                    <label for="depositante">Numero de Cuenta</label>
                                    <input type="text" class="form-control"  name="num" id="num" placeholder="Nombre">
                                </div>  

                                <div class="form-group">
                                    <label for="exampleInputPassword1">Monto a Retirar</label>
                                    <input type="number" class="form-control"  name="monto" id="monto" placeholder="Cantidad">
                                </div>
                            </div>
